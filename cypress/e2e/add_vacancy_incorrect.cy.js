    ...
    it('Existent login test', () => {
        cy.fixture('cypressTests').then(data => {
            ...
            cy.get('.vacancy-add-form-wrapper > .form > :nth-child(1) > .form__labels > .labels > :nth-child(1) > .form-control--responsive > .form-input--')
                .type(data.incorrect_vacancy_name, {force: true})
            ...
            cy.get('.vacancy-add-form-wrapper > .form > :nth-child(1) > .form__labels > .labels > :nth-child(4) > [data-v-af677f15=""] > :nth-child(1) > .radio-list > :nth-child(2) > .radio-component__input')
                .click()
